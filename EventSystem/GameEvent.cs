	...
	public class GameEvent : IGameEvent {
		...
		*/
		...
		public void Bind( in IGameEvent? otherEvent ) {
			...
			GameEventBus.BindEventFriend( this, otherEvent );
			...
			if ( HasFriend( in otherEvent, out _ ) ) {
				ConsoleSystem.Console.PrintWarning( $"GameEvent.Bind: friendship between events '{Name}' and '{otherEvent.Name}' created twice." );
				return;
			}
		...
		*/
		...
		public void Unbind( in IGameEvent? otherEvent ) {
			...
			if ( !HasFriend( in otherEvent, out int index ) ) {
				ConsoleSystem.Console.PrintError( $"GameEvent.Unbind: no friendship found between event '{Name}' and '{otherEvent.Name}'" );
				return;
			}
