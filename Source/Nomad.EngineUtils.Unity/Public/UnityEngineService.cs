...
namespace Nomad.EngineUtils
{
    ...
    public sealed class UnityEngineService : IEngineService
    {
        ...
        {
            StorageScope.Install => NormalizePath(Directory.GetParent(Application.dataPath) != null ? Directory.GetParent(Application.dataPath).FullName : Application.dataPath),
