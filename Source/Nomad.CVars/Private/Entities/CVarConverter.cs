...
namespace Nomad.CVars.Private.Entities {
	...
	*/
	...
	internal struct CVarConverter<T> {
		...
		*/
		/// <summary>
		/// Retrieves the CVar's <see cref="_value"/> as a string.
		/// </summary>
		/// <returns>The <see cref="_value"/> in string format.</returns>
		...
		*/
		/// <summary>
		/// Retrieves the CVar's <see cref="_value"/> as a 32-bit integer.
		/// </summary>
		/// <returns>The <see cref="_value"/> in 32-bit integer format, 0 by default if int.TryParse failed</returns>
		[MethodImpl( MethodImplOptions.AggressiveInlining )]
		...
		*/
		/// <summary>
		/// Retrieves the CVar's <see cref="_value"/> as a 32-bit floating-point.
		/// </summary>
		/// <returns>The <see cref="_value"/> in 32-bit floating-point format, 0 by default if float.TryParse failed</returns>
		[MethodImpl( MethodImplOptions.AggressiveInlining )]
		...
		*/
		/// <summary>
		/// Retrieves the CVar's <see cref="_value"/> as an 8-bit boolean.
		/// </summary>
		/// <returns>The <see cref="_value"/> in 8-bit boolean format, false by default if bool.TryParse failed</returns>
		[MethodImpl( MethodImplOptions.AggressiveInlining )]
		...
		*/
		...
		public void SetIntegerValue( int value )
			=> _value = _type == CVarType.Int ? Unsafe.As<int, T>(ref Unsafe.AsRef(in value)) : throw new InvalidCastException( $"CVar type mismatch: expected integer but instead got '{_type}'" );
		...
		*/
		...
		public void SetUIntegerValue( uint value )
			=> _value = _type == CVarType.UInt ? Unsafe.As<uint, T>(ref Unsafe.AsRef(in value)) : throw new InvalidCastException( $"CVar type mismatch: expected unsigned integer but instead got '{_type}'" );
		...
		*/
		...
		public void SetBooleanValue( bool value )
			=> _value = _type == CVarType.Boolean ? Unsafe.As<bool, T>(ref Unsafe.AsRef(in value)) : throw new InvalidCastException( $"CVar type mismatch: expected boolean but instead got '{_type}'" );
		...
		*/
		...
		public void SetDecimalValue( float value )
			=> _value = _type == CVarType.Decimal ? Unsafe.As<float, T>(ref Unsafe.AsRef(in value)) : throw new InvalidCastException( $"CVar type mismatch: expected float but instead got '{_type}'" );
		...
		*/
		...
		public void SetStringValue( string value )
			=> _value = _type == CVarType.String ? Unsafe.As<string, T>(ref Unsafe.AsRef(in value)) : throw new InvalidCastException( $"CVar type mismatch: expected string but instead got '{_type}'" );
		...
		*/
		...
		/// <returns></returns>
		/// <exception cref="NotSupportedException">Thrown if the provided <paramref name="targetType"/> isn't a valid CVar <see cref="_value"/> type.</exception>
