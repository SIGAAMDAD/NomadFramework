...
{
    /// <summary>
    /// Declares the engine template for tab bar UI elements.
    /// </summary>
    [TemplateClass(Contract = typeof(ITabBar), GodotBase = "Godot.TabBar", UnityBase = "UnityEngine.MonoBehaviour")]
    ...
    [TemplateProperty(
        ...
        IsReadOnly = true,
        Documentation = "The number of tabs currently shown by the tab bar.")]
    [TemplateEvent(
        Name = "TabChanged",
