...
namespace NomadCore.Systems.EntitySystem.Infrastructure.Rendering {
	...
	*/
	...
	internal abstract class ServerRenderEntity : IRenderEntity {
		...
		public IGameEvent<EntityVisibilityChangedEventArgs> VisibilityChanged => _visibilityChanged;
		protected readonly IGameEvent<EntityVisibilityChangedEventArgs> _visibilityChanged;
		...
		===============
		*/
		public ServerRenderEntity( IGameEventRegistryService eventFactory, CanvasItem canvasItem ) {
			_visibilityChanged = eventFactory.GetEvent<EntityVisibilityChangedEventArgs>( Constants.Events.ENTITY_VISIBILITY_CHANGED_EVENT );
