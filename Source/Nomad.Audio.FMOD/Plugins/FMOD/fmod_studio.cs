...
{
    internal partial class STUDIO_VERSION
    {
    ...
    internal enum STOP_MODE : int
    {
        ALLOWFADEOUT,
        IMMEDIATE,
    }

    internal enum LOADING_STATE : int
    {
        UNLOADING,
        UNLOADED,
        LOADING,
    ...
    internal struct PROGRAMMER_SOUND_PROPERTIES
    {
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct TIMELINE_MARKER_PROPERTIES
    {
        public StringWrapper name;
        public int position;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct TIMELINE_BEAT_PROPERTIES
    {
        public int bar;
        public int beat;
        public int position;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct TIMELINE_NESTED_BEAT_PROPERTIES
    {
        public GUID eventid;
    ...
    internal delegate RESULT SYSTEM_CALLBACK(IntPtr system, SYSTEM_CALLBACK_TYPE type, IntPtr commanddata, IntPtr userdata);

    internal enum PARAMETER_TYPE : int
    {
        GAME_CONTROLLED,
        AUTOMATIC_DISTANCE,
    ...
    [Flags]
    internal enum PARAMETER_FLAGS : uint
    {
        READONLY = 0x00000001,
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct PARAMETER_DESCRIPTION
    {
        public StringWrapper name;
    ...
    internal enum USER_PROPERTY_TYPE : int
    {
        INTEGER,
        BOOLEAN,
        FLOAT,
    ...
    internal struct USER_PROPERTY
    {
        ...
        public readonly string stringValue() { return (type == USER_PROPERTY_TYPE.STRING) ? value.stringvalue : ""; }
    };
    ...
    [Flags]
    internal enum LOAD_BANK_FLAGS : uint
    {
        NORMAL = 0x00000000,
    ...
    [Flags]
    internal enum COMMANDCAPTURE_FLAGS : uint
    {
        NORMAL = 0x00000000,
    ...
    [Flags]
    internal enum COMMANDREPLAY_FLAGS : uint
    {
        NORMAL = 0x00000000,
    ...
    internal enum PLAYBACK_STATE : int
    {
        PLAYING,
        SUSTAINING,
        STOPPED,
    ...
    internal enum EVENT_PROPERTY : int
    {
        CHANNELPRIORITY,
        SCHEDULE_DELAY,
        SCHEDULE_LOOKAHEAD,
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct PLUGIN_INSTANCE_PROPERTIES
    {
        public IntPtr name;
        public IntPtr dsp;
    }
    ...
    [Flags]
    internal enum EVENT_CALLBACK_TYPE : uint
    {
        CREATED = 0x00000001,
    ...
    internal delegate RESULT EVENT_CALLBACK(EVENT_CALLBACK_TYPE type, IntPtr _event, IntPtr parameters);

    internal delegate RESULT COMMANDREPLAY_FRAME_CALLBACK(IntPtr replay, int commandindex, float currenttime, IntPtr userdata);
    internal delegate RESULT COMMANDREPLAY_LOAD_BANK_CALLBACK(IntPtr replay, int commandindex, GUID bankguid, IntPtr bankfilename, LOAD_BANK_FLAGS flags, out IntPtr bank, IntPtr userdata);
    internal delegate RESULT COMMANDREPLAY_CREATE_INSTANCE_CALLBACK(IntPtr replay, int commandindex, IntPtr eventdescription, out IntPtr instance, IntPtr userdata);

    internal enum INSTANCETYPE : int
    {
        NONE,
        SYSTEM,
        EVENTDESCRIPTION,
