...
namespace Nomad.EngineUtils.UserInterface
{
    ...
    public partial class EngineHorizontalSlider : Godot.HSlider, IHorizontalSlider
    {
        ...
        ///
        /// </summary>
        IGameEvent<float> ISlider.ValueChanged => _valueChanged;
        ...
        public sealed override void _Ready()
        {
            ...
            _valueChanged = GameEventRegistry.GetEvent<float>($"{GetHashCode()}:{Constants.Events.SLIDER_VALUE_CHANGED}", Constants.Events.NAMESPACE);
            ...
            ValueChanged += (value) => _valueChanged.Publish((float)value);
        }
