...
namespace NomadCore.Systems.LobbySystem {
	...
	*/
	/// <summary>
	/// A representation of a Steam user's data.
	/// </summary>

	public sealed class User {
		public readonly CSteamID UserID;
		public readonly string? UserName;
		public readonly Server.ClientConnection? Connection;
		public readonly VoiceActivity Voice;
		...
		*/
		public User( CSteamID steamId ) {
			...
			Connection = new Server.ClientConnection();
