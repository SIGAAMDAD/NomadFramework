...
namespace NomadCore.Systems.LobbySystem {
	...
	*/
	...
	public class MatchmakingListHandler : ISteamMatchmakingServerListResponse {
		public MatchmakingListHandler()
			: base( OnServerResponded, OnServerFailedToRespond, OnRefreshComplete ) {
		}
