...
namespace NomadCore.Systems.SaveSystem.Common {
	public static class Events {
		...
		public static readonly SaveFailed SaveFailed = new SaveFailed();

		public static readonly LoadStarted LoadStarted = new LoadStarted();
		public static readonly LoadCompleted LoadCompleted = new LoadCompleted();
		public static readonly LoadFailed LoadFailed = new LoadFailed();
	};
};